...
async function sobelImg(blob: Blob) {
    ...
    (marginPointNum = pointNum * 90), (randomPointNum = pointNum * 10);
        ...
        <div class="slider">
            <div class="slider-input">
                ...
                <input
                    ...
                    :min="pointRange[0]"
                    :max="pointRange[1]"
                    v-model="userPointNum"
                    @change="changePointNum"
                />
            </div>
            <div class="slider-input">
                <p>
                    边缘随机点数比,0-1越大轮廓越清晰({{
                        userMarginRandom / 100
                    }})
                </p>
                <input
                    type="range"
                    min="1"
                    v-model="userMarginRandom"
                    @change="changeMarginRandom"
                />
            </div>
        </div>
        <div class="btn-box">
